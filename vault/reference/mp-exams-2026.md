...
| MP High Court Assistant Gr-III | `mp-hc-ag3` | MP High Court | Written Prelims + Hindi Typing (50m) + DV | Written **CONFIRMED** (100Q/100/120min, 5 subjects×20Q, **NO negative marking** — validated 2026-09-03, mphc reporting). No separate Mains. Typing = non-MCQ (0.5 deduction/error). **Deep-filled: 2 mocks + 3 packages.** | P1 | Apply 17 Aug–15 Sep; exam date TBD (~1,174 posts) |
| MPESB Group-3 (Sub Engineer etc.) | `mpesb-group-3` | MPESB | Written (Section A 100Q General + Section B 100Q post-technical) | Written **CONFIRMED** (200Q/200/180min, **no negative**, bilingual — validated 2026-09-03). **Deep-filled: Common General series** (2 free 100Q mocks + 3 packages). Technical streams (Civil/Electrical/Mech/…) per demand. | P1 | Apply 29 Aug–12 Sep; exam from **7 Oct 2026** (imminent) |
| MPPSC State Service | `mppsc-state-service` | MPPSC | Prelims (Paper I GS + Paper II CSAT, 2-paper set) + Mains (descriptive) + Interview | **TENTATIVE / blocked** — each paper 200 marks/2hr, Paper II qualifying (33%); **negative marking DISPUTED** (2026 may have introduced it) + Q-count unclear (100/200). Blockers: (1) confirm official pattern; (2) Phase B (2-paper set-as-unit; descriptive Mains outside MCQ engine). No mocks/packages. | P1 | Prelims 26 Apr (done); Mains 7–12 Sep 2026 |
| MPESB Group-2 Sub Gr-1 / Krishi Vistar Adhikari | `mpesb-group-2-sg1` | MPESB | Written (Part A 100 general + Part B 100 Agriculture) | **CONFIRMED** (200Q/200/180min, **negative 0.25/wrong**, bilingual — validated 2026-09-04). Single post, fixed agri syllabus. **Deep-filled: 2 full 200Q mocks + 3 packages.** | P2 | Apply 3–17 Jul; exam **17 Sep 2026** (2,784 posts) |
...
1. ✅ MP SI (Prelims; Mains validated 1/3 negative — finalize via Phase B) · 2. ✅ MP HC AG-III · 3. ✅ MPESB Group-3 (Common General) · 4. ✅ MPESB Group-2 Krishi · 5. ⏸ MPPSC State Service (blocked: pattern disputed + Phase B) · 6. ⏳ MPPSC Forest.
